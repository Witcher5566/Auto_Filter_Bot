...
PICS = (environ.get('PICS', 'https://graph.org/file/4afad3acc7e35ab6b1a35-4262db63d9f78220b2.jpg https://graph.org/file/8b87f007c9765e50156bd-1fd704b161e757e87b.jpg https://graph.org/file/da912dfa4817a7dc8bb98-edd60c7ee634615f6b.jpg')).split() 
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7364818327').split()]  #Admin Id
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002332540081 -1002075429339 -1002454842046 -1001854800053 -1002077178570').split()] #Movie Database Channel Id
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002149281691'))  #Log Channel Id
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002149281691'))  #Streming Log Channel Id
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-100'))  #Movie Update Channel Id
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002149281691')) #Premium Subscription Log Channel Id
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002149281691') #Movie Request Channel Id
...
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-1002370466536')) 
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1002370466536'))
...
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/How_To_Open_Linkl")

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "f1fa0e3f6a97025f24c2be2e80c7b8547df1ebd2")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "arolinks.com")

SHORTENER_API2 = environ.get("SHORTENER_API2", "f1fa0e3f6a97025f24c2be2e80c7b8547df1ebd2")
